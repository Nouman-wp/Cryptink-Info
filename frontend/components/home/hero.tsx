        ...
        <div className="container mx-auto px-4 py-24 sm:py-32 relative z-10 flex-1 flex flex-col">
          <div className="mx-auto max-w-4xl text-center flex-1 flex flex-col justify-center">
            ...
            >
              <h1 id="main-title" className="text-4xl font-bold tracking-tight text-foreground sm:text-6xl lg:text-7xl">
                Write <strong>collaboratively</strong> <span>&</span> <br />
                <strong>own</strong> your work <em className="italic">forever</em>
              </h1>
            </motion.div>
            ...
            >
              CryptInk is a decentralized collaborative writing platform powered by Solana blockchain.
              Write, collaborate, and publish with end-to-end encryption, AI assistance, and transparent royalty distribution.
            </motion.p>
            ...
            >
              ...
              <div className="flex items-center justify-center gap-4">
                ...
                <a href="/browse" className="px-6 py-3 rounded-full border border-border/50 bg-background/50 backdrop-blur-sm hover:bg-background/80 transition-all text-sm font-medium">
                  Browse Books
                </a>
              </div>
            </motion.div>
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
              <div className="text-center p-6 rounded-2xl border border-border/50 bg-background/30 backdrop-blur-sm">
                ...
                <p className="text-sm text-muted-foreground">Your manuscripts are encrypted and stored on Arweave, ensuring complete privacy</p>
              </div>
              ...
              <div className="text-center p-6 rounded-2xl border border-border/50 bg-background/30 backdrop-blur-sm">
                ...
                <p className="text-sm text-muted-foreground">Work together with co-authors and track contributions on-chain</p>
              </div>
              ...
              <div className="text-center p-6 rounded-2xl border border-border/50 bg-background/30 backdrop-blur-sm">
                ...
                <h3 className="font-semibold mb-2">Transparent Royalties</h3>
                <p className="text-sm text-muted-foreground">Automated royalty distribution via smart contracts on Solana</p>
              </div>
            </div>
          </motion.div>
        </div>
